<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AreaPersonale.aspx.cs" Inherits="AreaPersonale" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12" style="margin-top:3%">
            <div class="col-md-4" style="background-color:#990000; text-align:center; font-size:20px">
                <a href="Default.aspx"><b><asp:Label ID="lblHome" runat="server" Text="Home"></asp:Label></b></a>
            </div>
            <div class="col-md-4" style="background-color:green; text-align:center; font-size:20px">
                <a href="Default.aspx"><b><asp:Label ID="lblOfferte" runat="server" Text="Offerte"></asp:Label></b></a>
            </div>
            <div class="col-md-4" style="background-color:#990000; text-align:center; font-size:20px">
                <a href="Default.aspx"><b><asp:Label ID="LblAreaPersonale" runat="server" Text="Area Personale"></asp:Label></b></a>
            </div>
        </div>
